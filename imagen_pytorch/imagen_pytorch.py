...
class Unet(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.final_res_block = ResnetBlock(final_conv_dim, dim, time_cond_dim = time_cond_dim, groups = resnet_groups[0], skip_connection_scale = 1., use_gca = use_global_context_attn) if final_resnet_block else None
